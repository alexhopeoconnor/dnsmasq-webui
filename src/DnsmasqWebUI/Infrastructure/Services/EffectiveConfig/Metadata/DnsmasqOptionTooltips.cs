...
public static class DnsmasqOptionTooltips
{
    private static readonly FrozenDictionary<string, string> Tooltips = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [DnsmasqConfKeys.AddCpeId] = "Add an identifying string to DNS queries forwarded upstream (EDNS0).",
        ...
        [DnsmasqConfKeys.Dumpfile] = "Pcap file path for packet capture (debugging).",
        [DnsmasqConfKeys.Dumpmask] = "Bitmask selecting which packet types are written to the dump file.",
