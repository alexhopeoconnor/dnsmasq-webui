...
namespace DnsmasqWebUI.Infrastructure.Services.EffectiveConfig.Rendering.Abstractions;
...
public interface IEffectiveConfigRenderFragmentRegistry : IApplicationSingleton
{
    ...
    /// </summary>
    RenderFragment<EffectiveConfigMultiDisplayContext>? BuildMultiFieldComponentFragment(string sectionId, string optionName, EventCallback<IReadOnlyList<string>> onValuesChanged);
