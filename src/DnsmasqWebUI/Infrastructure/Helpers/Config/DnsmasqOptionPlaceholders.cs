...
public static class DnsmasqOptionPlaceholders
{
    private static readonly FrozenDictionary<string, string> Values = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [DnsmasqConfKeys.DhcpCircuitid] = "tag:uplink,example-circuit",
        [DnsmasqConfKeys.DhcpRemoteid] = "tag:uplink,example-remote",
        [DnsmasqConfKeys.DhcpSubscrid] = "tag:uplink,example-subscriber",
