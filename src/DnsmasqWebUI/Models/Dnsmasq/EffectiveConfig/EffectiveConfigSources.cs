...
public record EffectiveConfigSources(
    ...
    IReadOnlyList<ValueWithSource> DhcpOptsdirPaths,
    ...
    ConfigValueSource? DnssecCheckUnsigned, // single value (empty or "no")
    ...
    ConfigValueSource? ConnmarkAllowlistEnable, // single value (empty or mask)
    ConfigValueSource? NoRoundRobin,
    ConfigValueSource? DnssecNoTimecheck,
    ConfigValueSource? DnssecDebug,
    IReadOnlyList<ValueWithSource> LeasequeryValues,
